      ...
      <body>
        <div className="fixed inset-0 flex items-center justify-center p-5 w-full">
          <div className="text-center">
            ...
            <h2 className="mt-5 text-[36px] font-bold lg:text-[50px]">500 - Server Error</h2>
            <p className="mt-5 lg:text-lg">
              Oops something went wrong. Try to refresh this page or <br /> feel free to contact us
